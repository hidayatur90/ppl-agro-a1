                ...
                <div class="form-edit">
                    <form method="post" action="/karyawanProduksi/store">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8 col-md-9 col-xl-10">
                                <input type="text" pattern="[0-9]{10,13}" class="form-control" name="noTelepon" id="noTelepon" placeholder="08xxxxxxxxxx" required oninvalid="this.setCustomValidity('Mohon diisi dengan angka, minimal 10 digit, maksimal 13 digit')" oninput="this.setCustomValidity('')" onkeypress='validate(event)'/>
