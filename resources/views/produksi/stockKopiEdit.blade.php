                        ...
                        <div class="col-sm-8 col-md-9 col-xl-10">
                            ...
                            @if($p->kategori=='Biji Kopi')
                                @foreach ($last_price_biji as $lp)
                                    <input type="number" class="form-control" min="500" step="500" name="hargaPer100Gram" id="hargaPer100Gram" placeholder="Harga Per 100 Gram" autocomplete="off" required oninvalid="this.setCustomValidity('Inputan Min 1000')" oninput="this.setCustomValidity('')" value="{{ $lp }}"/>
                                @endforeach
                            @else
