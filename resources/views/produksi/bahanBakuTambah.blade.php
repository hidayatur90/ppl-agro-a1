            ...
            <div class="form-edit">
                <form method="post" action="/bahanBaku/store">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8 col-md-9 col-xl-10">
                            <input type="number" class="form-control" min="0" step="1000" name="hargaSatuan" id="hargaSatuan" placeholder="Harga Satuan" autocomplete="off" required oninvalid="this.setCustomValidity('Harga satuan harus angka')" oninput="this.setCustomValidity('')"/>
